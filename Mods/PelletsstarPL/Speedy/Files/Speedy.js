...
G.createTopInterface=function()
	{
		...
		G.button({id:'pauseButton',
			text:'<div class="image" style="width:9px;background:url(https://raw.githubusercontent.com/Stake2/NeverEnding_Legacy/refs/heads/main/Mods/PelletsstarPL/Speedy/Files/playButtons.png) 0px 0px;"></div>',
		...
		G.button({id:'playButton',
			text:'<div class="image" style="width:9px;background:url(https://raw.githubusercontent.com/Stake2/NeverEnding_Legacy/refs/heads/main/Mods/PelletsstarPL/Speedy/Files/playButtons.png) -11px 0px;"></div>',
		...
		G.button({id:'fastButton',
			text:'<div class="image" style="width:9px;background:url(https://raw.githubusercontent.com/Stake2/NeverEnding_Legacy/refs/heads/main/Mods/PelletsstarPL/Speedy/Files/playButtons.png) -21px 0px;"></div>',
    	...
    	G.button({id:'customSpeedButton',
			text:'<div class="image" style="width:9px;background:url(https://raw.githubusercontent.com/Stake2/NeverEnding_Legacy/refs/heads/main/Mods/PelletsstarPL/Speedy/Files/playButtons.png) -31px 0px;"></div>',
