...
func:function()
{
	...
	*/
	...
	new G.Res({
		...
		icon:[2,6],
		partOf:'food','archaic building materials',
		category:'build',
	});
	new G.Res({
		name:'stick',
	...
	new G.Res({
		...
		icon:[0,8],
		partOf:'food','basic building materials',
		category:'build',
	});
	new G.Res({
		name:'log',
	...
	new G.Res({
		...
		icon:[4,8],
		partOf:'food','advanced building materials',
		category:'build',
	});
	new G.Res({
		name:'concrete',
	...
	new G.Res({
		...
		icon:[7,8],
		partOf:'food','precious building materials',
		category:'build',
	});
	new G.Res({
		name:'gold block',
